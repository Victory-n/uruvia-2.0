...
import 'package:uruvia/shared_features/calculator/widgets/breakdown_results_card.dart';
import 'package:uruvia/shared_features/calculator/widgets/input_card.dart';
import 'package:uruvia/shared_features/calculator/widgets/pro_insights_card.dart';
...
class _SavingsCalculatorScreenState extends State<SavingsCalculatorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: const IndividualDrawer(selectedIndex: 5), // Index 5 for Calculator
