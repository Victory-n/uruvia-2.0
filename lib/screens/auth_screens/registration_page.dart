...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      // Simulate a small delay for a premium user experience before proceeding
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        leading: IconButton(
          icon: const Icon(Icons.arrow_back, color: ConstantColor.headingTextPrimary),
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ButtonStyle(
                    fixedSize: WidgetStateProperty.all(Size(MediaQuery.of(context).size.width, 50.0)),
